...
public class TitleDisplay extends Display {
	...
	public TitleDisplay() {
		...
		super(true, false, new Menu.Builder(true, 1, RelPos.CENTER,
	...
	public void render(Screen screen) {
		...
		Font.draw(Localization.getLocalized("minicraft.displays.title.display.version", Game.MODVERSION), screen, 1, 10, Color.get(1, 51));
	    //Font.draw("Mod by PHITHGOD24 >:3", screen, Screen.w - 128, Screen.h - 128, Color.get(-1, 240, 240, 240));
	...
	private static final String[] splashes = {
       ...
       "THIS SPLASH IS REALY LONGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGGG",
       "meat",
		"beepboop!",
		...
		"NOW WITH Austria!!!",
		"Russia?!",
		"POLANDBALL AHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH!",
		"WW3 Before GTA6!",
		"Diddy",
		"Meatgod",
		"Dont you dare >:(",
