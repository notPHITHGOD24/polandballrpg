...
public class StackableItem extends Item {
	...
	protected static ArrayList<Item> getAllInstances() {
		...
		items.add(new StackableItem("Feather", new LinkedSprite(SpriteType.Item, "feather"))); 
		...
		items.add(new StackableItem("Copper", new LinkedSprite(SpriteType.Item, "copper_ingot")));
		items.add(new StackableItem("Copper Ore", new LinkedSprite(SpriteType.Item, "copper_ore")));
