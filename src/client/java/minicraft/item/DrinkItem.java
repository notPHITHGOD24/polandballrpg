...
public class DrinkItem extends StackableItem {
	...
	protected static ArrayList<Item> getAllInstances() {
		...
		items.add(new DrinkItem("Dirty water", new LinkedSprite(SpriteType.Item, "dirty_water"), 1));
		items.add(new DrinkItem("Purified water", new LinkedSprite(SpriteType.Item, "purified_water"), 5));
	...
	private DrinkItem(String name, LinkedSprite sprite, int feed) {
		this(name, sprite, 1, feed);
	}

	private DrinkItem(String name, LinkedSprite sprite, int count, int feed) {
