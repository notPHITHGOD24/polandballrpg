...
public class TileItem extends StackableItem {
	...
	protected static ArrayList<Item> getAllInstances() {
		...
		items.add(new TileItem("Mature Coconut", new LinkedSprite(SpriteType.Item, "old_coconut"), new TileModel("palm sapling"), "sand" ));
		...
		items.add(new TileItem("Small Stone", SpriteLinker.missingTexture(SpriteType.Item), new TileModel("small stone"), "dirt", "grass", "hole"));
