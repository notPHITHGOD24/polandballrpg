...
public class FoodItem extends StackableItem {
	...
	protected static ArrayList<Item> getAllInstances() {
		...
		items.add(new FoodItem("Raw Chicken", new LinkedSprite(SpriteType.Item, "chicken"), 1));
		...
		items.add(new FoodItem("Green Coconut", new LinkedSprite(SpriteType.Item, "green_coco"), 5));
