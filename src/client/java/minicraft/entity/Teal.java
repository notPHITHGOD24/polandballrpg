...
public class Teal extends Entity implements ClientTickable {
	private Direction dir;
	private int damage;
	public Mob owner;
	private int speed;
	private LinkedSprite sprite = new LinkedSprite(SpriteType.Entity, "cuter").setSpriteSize(1, 1);

	public Teal(Mob owner, Direction dir, int dmg) {
		this(owner, owner.x, owner.y, dir, dmg);
	}

	public Teal(Mob owner, int x, int y, Direction dir, int dmg) {
	...
	/**
	 * Generates information about the Teal.
