...
public class Chicken extends PassiveMob {
	private static LinkedSprite[][] sprites = Mob.compileMobSpriteAnimations(0, 0, "chicken");
	...
	public void die() {
		...
		dropItem(min, max, Items.get("raw chicken"), Items.get("raw egg"), Items.get("feather"));
