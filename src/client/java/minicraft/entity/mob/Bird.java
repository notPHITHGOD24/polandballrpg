...
public class Bird extends PassiveMob {
	private static LinkedSprite[][] sprites = Mob.compileMobSpriteAnimations(0, 0, "bird");
	...
	public void die() {
		...
		dropItem(min, max, Items.get("raw egg"), Items.get("feather"));
