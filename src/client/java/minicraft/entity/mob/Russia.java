...
public class Russia extends EnemyMob {
	private static final LinkedSprite[][][] sprites = new LinkedSprite[][][] {
		Mob.compileMobSpriteAnimations(0, 0, "russia")
	};

	public static boolean beaten = false;
	public static boolean active = false;
	public static Russia entity = null;
	 ...
	 */
	public Russia(int lvl) {
		this();
	}

	/**
	 * Constructor for the Russia.
	 */
	public Russia() {
	...
	public void die() {
		...
		Analytics.RussiaDeath.ping();
		Updater.notifyAll(Localization.getLocalized("minicraft.notification.russia_defeated"));


		// If this is the first time we beat the air wizard.
		if (!beaten) {
			AchievementsDisplay.setAchievement("minicraft.achievement.russia", true);

			Analytics.FirstRussiaDeath.ping();
		}
