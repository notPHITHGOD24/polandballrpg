...
public final class Tiles {
	...
	public static void initTileList() {
		...
		tiles.put((short) 89, new PalmTile("Palm"));
		tiles.put((short) 90, new PalmSaplingTile("Palm Sapling", Tiles.get("Sand"), Tiles.get("Palm")));
		...
		tiles.put((short) 77, new OreTile(OreTile.OreType.Copper));
		...
		tiles.put((short) 75, new TallGrassTile());
		tiles.put((short) 76, new SmallStoneTile());
