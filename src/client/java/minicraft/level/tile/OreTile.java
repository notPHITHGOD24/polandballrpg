...
public class OreTile extends Tile {
	...
	public enum OreType {
		Copper(Items.get("Copper Ore"), new SpriteAnimation(SpriteType.Tile, "copper_ore")),
		...
		Emerald(Items.get("Emerald Ore"), new SpriteAnimation(SpriteType.Tile, "emerald_ore"));
