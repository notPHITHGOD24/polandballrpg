...
public class PalmSaplingTile extends Tile {
	private static final SpriteAnimation sprite = new SpriteAnimation(SpriteType.Tile, "palm_sapling");

	private Tile onType;
	private Tile growsTo;

	protected PalmSaplingTile(String name, Tile onType, Tile growsTo) {
		super(name, sprite);
		this.onType = onType;
